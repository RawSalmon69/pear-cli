---
name: Bug Report
about: Report a bug or issue with Pear
title: '[BUG] '
labels: bug
assignees: ''
---
...
Please run `pe update` to ensure you are on the latest version, then paste the output of `pe --version` below:

```text
Paste pe --version output here
```
