...
show_installer_help() {
    echo "Usage: pe installer [OPTIONS]"
    echo ""
...
show_optimize_help() {
    echo "Usage: pe optimize [OPTIONS]"
    echo ""
...
show_uninstall_help() {
    echo "Usage: pe uninstall [OPTIONS] [APP_NAME ...]"
    echo ""
    ...
    echo "For leftovers from apps that are already gone, use pe clean."
    echo ""
    echo "Examples:"
    echo "  pe uninstall                   Open interactive app selector"
    echo "  pe uninstall slack             Uninstall Slack"
    echo "  pe uninstall slack zoom        Uninstall Slack and Zoom"
    echo "  pe uninstall --dry-run slack   Preview Slack uninstallation"
    echo "  pe uninstall --list            Show installed apps and the names pe uninstall accepts"
    echo ""
    echo "Options:"
    echo "  --list            List installed apps with the exact name pe uninstall accepts"
