...
# RawSalmon69/pear-cli release. Usage: post-reactions.sh V<version>
...
RELEASE_ID=$(gh api "repos/RawSalmon69/pear-cli/releases/tags/$TAG" --jq '.id')
...
for r in +1 laugh hooray heart rocket eyes; do
    gh api "repos/RawSalmon69/pear-cli/releases/$RELEASE_ID/reactions" \
