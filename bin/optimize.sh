...
main() {
    ...
    export PEAR_CURRENT_COMMAND="optimize"
    ...
    for arg in "$@"; do
        case "$arg" in
            ...
            *)
                ...
                echo "Use 'pe optimize --help' for supported options."
                exit 1
                ;;
        esac
    done
    ...
    export PEAR_OPTIMIZE_SUDO_AVAILABLE="false"
    if [[ "${PEAR_DRY_RUN:-0}" == "1" ]]; then
        PEAR_OPTIMIZE_SUDO_AVAILABLE="true"
