...
HISTORY_JSON=false
HISTORY_LIMIT="$PEAR_HISTORY_DEFAULT_LIMIT"

show_history_help() {
    echo "Usage: pe history [OPTIONS]"
    echo ""
    echo "Review recent Pear operation and deletion activity."
    echo ""
    echo "Options:"
    ...
    while [[ $# -gt 0 ]]; do
        case "$1" in
            ...
            "--help" | "-h")
                ...
                ;;
            -*)
                echo "Unknown option for pe history: $1" >&2
                echo "Run 'pe history --help' for usage." >&2
                exit 1
                ;;
            *)
                echo "Unexpected argument for pe history: $1" >&2
                echo "Run 'pe history --help' for usage." >&2
                exit 1
                ;;
        esac
