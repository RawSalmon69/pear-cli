...
//
// Vendored verbatim (Services/SunburstViewportTransform.swift): the anchor-
// preserving zoom, drag/scroll pan, and offset-clamping math for the sunburst
// viewport. Zero dependencies — pure CoreGraphics.
