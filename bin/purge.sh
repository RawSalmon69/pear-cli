...
start_purge() {
    ...
    export PEAR_CURRENT_COMMAND="purge"
...
# Show help message
show_help() {
    echo -e "${PURPLE_BOLD}Pear Purge${NC}, Clean old project build artifacts"
    echo ""
    echo -e "${YELLOW}Usage:${NC} pe purge [options]"
    echo ""
    ...
    for arg in "$@"; do
        case "$arg" in
            ...
            *)
                ...
                echo "Use 'pe purge --help' for usage information"
                exit 1
                ;;
        esac
    done
