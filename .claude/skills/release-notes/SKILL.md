...
- **Verify every command mentioned in the notes actually exists in HEAD**. CLAUDE.md cites `pe check / pe doctor` as a case where a removed command nearly shipped as a "feature".
