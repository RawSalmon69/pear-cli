...
Pear is a local system maintenance tool. It includes high-risk operations such as cleanup, uninstall, optimization, and artifact removal. We treat safety boundaries, deletion logic, and release integrity as security-sensitive areas.

## Reporting a Vulnerability

Please report suspected security issues privately.

- Email: `worached.ink@dappmaker.co.th`
- Subject line: `Pear security report`
...
- Pear version and install method
- macOS version
...
- False negatives where Pear refuses to clean something
...
## Security-Focused Areas in Pear
